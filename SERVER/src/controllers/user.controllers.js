...
const changeCurrentPassword = asyncHandler(async (req, res) => {
  // todos:
  // 1. fetch the new password,old password from req.body
  // 2. obtain user from req.user
  // 3. check if old password is correct
  // 4. save the new password in db
...
const updateUserAvatar = asyncHandler(async(req,res)=>{
    ...
    const avatarUrl = uploadToCloudinary(avatarLocalPath)

    if(!avatarUrl) throw new ApiError(400,"Error while uploading the file")
